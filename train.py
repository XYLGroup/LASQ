...
def parse_args_and_config():
    ...
    parser.add_argument('--seed', default=36, type=int, metavar='N',
    ...
    parser.add_argument('--mcmc_steps', type=int, default=100, help='MCMC sampling steps')
    parser.add_argument('--mcmc_std', type=float, default=0.03, help='MCMC random walk proposal std')
    parser.add_argument('--mcmc_temp', type=float, default=0.02, help='MCMC MH gate temperature')
